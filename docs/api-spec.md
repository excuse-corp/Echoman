...
- ✅ POST `/ingest/run`
  ...
  - 说明：每日3次归并，每次2阶段：
    - **上午（AM）**：12:15阶段一，12:30阶段二（处理8:00/10:00/12:00采集数据）
    - **下午（PM）**：18:15阶段一，18:30阶段二（处理14:00/16:00/18:00采集数据）
    - **傍晚（EVE）**：22:15阶段一，22:30阶段二（处理20:00/22:00采集数据）
...
```
{
  "ingest":{
    ...
    "event_merge": {
      "last_merge_at": "2025-11-07T22:15:00Z",
      "period": "EVE",
      "input_items": 459,
      "kept_items": 377,
      "dropped_items": 82,
    ...
    "global_merge": {
      "last_merge_at": "2025-11-07T22:30:00Z",
      "period": "EVE",
      "input_events": 132,
      "merge_count": 56,
      "new_count": 76,
...
### 半日归并（Halfday Merge）
- **上半日（AM）**：8:00、10:00、12:00 三次采集，12:15 触发归并
- **下半日（PM）**：14:00、16:00、18:00、20:00、22:00 五次采集，22:15 触发归并
...
### 整体归并（Global Merge）
- **触发时机**：12:30 和 22:30（半日归并后 15 分钟）
